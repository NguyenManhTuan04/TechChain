        ...
        <div class="ibox-content">
            <form action="{{ route('admins.category.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <img id="image_category" src="" width="150px" style="display: none;">
                </div>
                <div class="form-group">
                    <label class="form-label" for="">Trạng Thái</label>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="is_type" value="1" checked> Hiển Thị
                        <input class="form-check-input" type="radio" name="is_type" value="0"> Ẩn
                    </div>
