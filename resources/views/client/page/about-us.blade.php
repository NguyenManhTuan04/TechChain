...
<div id="content">
    ...
    <section class="cultur-block">
        <ul>
            <li> <img src="{{ asset('assets/client/images/cultur-img-1.jpg') }}" alt=""> </li>
            <li> <img src="{{ asset('assets/client/images/cultur-img-2.jpg') }}" alt=""> </li>
            <li> <img src="{{ asset('assets/client/images/cultur-img-3.jpg') }}" alt=""> </li>
            <li> <img src="{{ asset('assets/client/images/cultur-img-4.jpg') }}" alt=""> </li>
        </ul>
        ...
        <div class="container">
            ...
            <ul class="row">
                ...
                <li class="col-md-4 text-center animate fadeInUp" data-wow-delay="0.4s">
                    <article>
                        <!-- abatar -->
                        <div class="avatar"> <img class="img-circle" src="{{ asset('assets/client/images/team-1.jpg') }}" alt="">
                            <!-- Team hover -->
                ...
                <li class="col-md-4 text-center animate fadeInUp" data-wow-delay="0.6s">
                    <article>
                        <!-- abatar -->
                        <div class="avatar"> <img class="img-circle" src="{{ asset('assets/client/images/team-2.jpg') }}" alt="">
                            <!-- Team hover -->
                            <div class="team-hover">
                                <div class="position-center-center">
                                    <div class="social-icons"> <a href="#."><i
                ...
                <li class="col-md-4 text-center animate fadeInUp" data-wow-delay="0.8s">
                    <article>
                        <!-- abatar -->
                        <div class="avatar"> <img class="img-circle" src="{{ asset('assets/client/images/team-3.jpg') }}" alt="">
                            <!-- Team hover -->
                            <div class="team-hover">
                                <div class="position-center-center">
                                    <div class="social-icons"> <a href="#."><i
                ...
                <li class="col-md-4 text-center">
                    <article>
                        <!-- abatar -->
                        <div class="avatar"> <img class="img-circle" src="{{ asset('assets/client/images/team-4.jpg') }}" alt="">
                            <!-- Team hover -->
                            <div class="team-hover">
                                <div class="position-center-center">
                                    <div class="social-icons"> <a href="#."><i
                ...
                <li class="col-md-4 text-center">
                    <article>
                        <!-- abatar -->
                        <div class="avatar"> <img class="img-circle" src="{{ asset('assets/client/images/team-5.jpg') }}" alt="">
                            <!-- Team hover -->
                            <div class="team-hover">
                                <div class="position-center-center">
                                    <div class="social-icons"> <a href="#."><i
                ...
                <li class="col-md-4 text-center">
                    <article>
                        <!-- abatar -->
                        <div class="avatar"> <img class="img-circle" src="{{ asset('assets/client/images/team-6.jpg') }}" alt="">
                            <!-- Team hover -->
                            <div class="team-hover">
                                <div class="position-center-center">
                                    <div class="social-icons"> <a href="#."><i
