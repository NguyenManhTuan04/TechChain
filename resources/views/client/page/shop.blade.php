            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <div class="shop-sidebar">
                        ...
                        <!-- SIDE BACR BANER -->
                        <div class="side-bnr margin-top-50"> <img class="img-responsive" src="{{ asset('assets/client/images/sidebar-bnr.jpg') }}"
                                alt="">
                            ...
                            <div class="row">
                                ...
                                <div class="item">
                                    <div class="img-ser">
                                        ...
                                        <!-- Images -->
                                        <div class="thumb"> <img class="img-1" src="{{ asset('assets/client/images/item-img-1-1.jpg') }}"
                                                alt=""><img class="img-2" src="{{ asset('assets/client/images/item-img-1-1-1.jpg') }}"
                                                alt="">
                                            <!-- Overlay  -->
                                            <div class="overlay">
                                        ...
                                        <!-- Item Name -->
                                        <div class="item-name fr-grd"> <a href="#." class="i-tittle">Mid Rise
                                                Skinny Jeans</a> <span class="price"><small>$</small><span
                                                    class="line-through">299.00</span> <small>$</small>199.00</span> <a
                                                class="deta animated fadeInRight" href="#.">View Detail</a>
                                        </div>
                                        <!-- Item Details -->
                                        <div class="cap-text">
                                            <div class="item-name"> <a href="#." class="i-tittle">Mid Rise
                                                    Skinny Jeans</a> <span class="price"><small>$</small><span
                                                ...
                                                <div class="stras"> <i class="fa fa-star"></i> <i
                                                        ...
                                                        href="#." class="wsh-list"><i class="icon-heart"></i>
                                ...
                                <div class="item">
                                    <div class="img-ser">
                                        <!-- Images -->
                                        <div class="thumb"> <img class="img-1" src="{{ asset('assets/client/images/item-img-1-2.jpg') }}"
                                                alt=""><img class="img-2" src="{{ asset('assets/client/images/item-img-1-2-1.jpg') }}"
                                                alt="">
                                            <!-- Overlay  -->
                                            <div class="overlay">
                                                <div class="position-center-center"> <a class="popup-with-move-anim"
                                        ...
                                        <!-- Item Name -->
                                        <div class="item-name fr-grd"> <a href="#." class="i-tittle">Mid Rise
                                                Skinny Jeans</a> <span class="price"><small>$</small>199.00</span> <a
                                                class="deta animated fadeInRight" href="#.">View Detail</a>
                                        </div>
                                        <!-- Item Details -->
                                        <div class="cap-text">
                                            <div class="item-name"> <a href="#." class="i-tittle">Mid Rise
                                                    Skinny Jeans</a> <span class="price"><small>$</small>199.00</span>
                                                <!-- Stars -->
                                ...
                                <div class="item">
                                    <div class="img-ser">
                                        <!-- Images -->
                                        <div class="thumb"> <img class="img-1" src="{{ asset('assets/client/images/item-img-1-3.jpg') }}"
                                                alt=""><img class="img-2" src="{{ asset('assets/client/images/item-img-1-3-1.jpg') }}"
                                                alt="">
                                            <!-- Overlay  -->
                                            <div class="overlay">
                                                <div class="position-center-center"> <a class="popup-with-move-anim"
                                ...
                                <div class="item">
                                    <div class="img-ser">
                                        <!-- Images -->
                                        <div class="thumb"> <img class="img-1" src="{{ asset('assets/client/images/item-img-1-4.jpg') }}"
                                                alt=""><img class="img-2" src="{{ asset('assets/client/images/item-img-1-4-1.jpg') }}"
                                                alt="">
                                            <!-- Overlay  -->
                                            <div class="overlay">
                                                <div class="position-center-center"> <a class="popup-with-move-anim"
                                ...
                                <div class="item">
                                    <div class="img-ser">
                                        <!-- Images -->
                                        <div class="thumb"> <img class="img-1" src="{{ asset('assets/client/images/item-img-1-5.jpg') }}"
                                                alt=""><img class="img-2" src="{{ asset('assets/client/images/item-img-1-5-1.jpg') }}"
                                                alt="">
                                            <!-- Overlay  -->
                                            <div class="overlay">
                                                <div class="position-center-center"> <a class="popup-with-move-anim"
                                ...
                                <div class="item">
                                    <div class="img-ser">
                                        <!-- Images -->
                                        <div class="thumb"> <img class="img-1" src="{{ asset('assets/client/images/item-img-1-6.jpg') }}"
                                                alt=""><img class="img-2" src="{{ asset('assets/client/images/item-img-1-6-1.jpg') }}"
                                                alt="">
                                            <!-- Overlay  -->
                                            <div class="overlay">
                                                <div class="position-center-center"> <a class="popup-with-move-anim"
                                ...
                                <div class="item">
                                    <div class="img-ser">
                                        <!-- Images -->
                                        <div class="thumb"> <img class="img-1" src="{{ asset('assets/client/images/item-img-1-7.jpg') }}"
                                                alt=""><img class="img-2" src="{{ asset('assets/client/images/item-img-1-7-1.jpg') }}"
                                                alt="">
                                            <!-- Overlay  -->
                                            <div class="overlay">
                                                <div class="position-center-center"> <a class="popup-with-move-anim"
                                ...
                                <div class="item">
                                    <div class="img-ser">
                                        <!-- Images -->
                                        <div class="thumb"> <img class="img-1" src="{{ asset('assets/client/images/item-img-1-8.jpg') }}"
                                                alt=""><img class="img-2" src="{{ asset('assets/client/images/item-img-1-8-1.jpg') }}"
                                                alt="">
                                            <!-- Overlay  -->
                                            <div class="overlay">
                                                <div class="position-center-center"> <a class="popup-with-move-anim"
                                ...
                                <div class="item">
                                    <div class="img-ser">
                                        <!-- Images -->
                                        <div class="thumb"> <img class="img-1" src="{{ asset('assets/client/images/item-img-1-9.jpg') }}"
                                                alt=""><img class="img-2" src="{{ asset('assets/client/images/item-img-1-9-1.jpg') }}"
                                                alt="">
                                            <!-- Overlay  -->
                                            <div class="overlay">
                                                <div class="position-center-center"> <a class="popup-with-move-anim"
                                ...
                                <div class="item">
                                    <div class="img-ser">
                                        <!-- Images -->
                                        <div class="thumb"> <img class="img-1" src="{{ asset('assets/client/images/item-img-1-10.jpg') }}"
                                                alt=""><img class="img-2" src="{{ asset('assets/client/images/item-img-1-10-1.jpg') }}"
                                                alt="">
                                            <!-- Overlay  -->
                                            <div class="overlay">
                                                <div class="position-center-center"> <a class="popup-with-move-anim"
                                ...
                                <div class="item">
                                    <div class="img-ser">
                                        <!-- Images -->
                                        <div class="thumb"> <img class="img-1" src="{{ asset('assets/client/images/item-img-1-11.jpg') }}"
                                                alt=""><img class="img-2" src="{{ asset('assets/client/images/item-img-1-11-1.jpg') }}"
                                                alt="">
                                            <!-- Overlay  -->
                                            <div class="overlay">
                                                <div class="position-center-center"> <a class="popup-with-move-anim"
                                ...
                                <div class="item">
                                    <div class="img-ser">
                                        <!-- Images -->
                                        <div class="thumb"> <img class="img-1" src="{{ asset('assets/client/images/item-img-1-12.jpg') }}"
                                                alt=""><img class="img-2" src="{{ asset('assets/client/images/item-img-1-12-1.jpg') }}"
                                                alt="">
                                            <!-- Overlay  -->
                                            <div class="overlay">
                                                <div class="position-center-center"> <a class="popup-with-move-anim"
